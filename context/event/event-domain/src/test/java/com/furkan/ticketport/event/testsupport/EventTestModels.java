...
public final class EventTestModels {

    public static final CategoryId SEED_CATEGORY =
            CategoryId.valueOf("b0000001-0000-4000-8000-000000000001");

    private EventTestModels() {}

    public static Event draftEvent(String titled) {
        return Event.create(EventId.valueOf("e0000001-0000-4000-8000-000000000099"), SEED_CATEGORY, Title.valueOf(titled));
    }
}
